...
public class MentorshipRequestServiceImpl implements MentorshipRequestService {
        ...
        public MentorshipRequestResponseDTO updateStatus(Long requestId, String status) {
                ...
                if ("APPROVED".equalsIgnoreCase(status)) {
                        // Default mentorship duration: 30 days
                        req.setExpiryDate(java.time.LocalDateTime.now().plusDays(30));
                ...
                if (req.getStartup().getFounder() != null) {
                        ...
                        String mentorName = (req.getMentor().getUser() != null) ? req.getMentor().getUser().getName()
                                        : "Mentor";
                        notificationService.createNotification(
                                        req.getStartup().getFounder(),
                                        "Mentor " + mentorName + " " + statusText + " your mentorship request for "
        ...
        private MentorshipRequestResponseDTO mapToDTO(MentorshipRequest req) {
                ...
                dto.setExpiryDate(req.getExpiryDate());
                return dto;
        }
}
